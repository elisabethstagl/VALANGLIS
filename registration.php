                ...
                <form action="<?= htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                    <div class="row">
                        <div class="col-12 col-lg-4 col-md-6 d-flex flex-column mb-3">
                            ...
                            <input type="text" id="username" name="username" class="retro-input <?php if ($submitted) echo empty($errUsername) ? 'is-valid' : 'is-invalid'; ?>" required value="<?= htmlspecialchars($username) ?>">
                            <div class="invalid-feedback"><?= $errUsername ?></div>
                        </div>

                        <div class="col-12 col-lg-4 col-md-6 d-flex flex-column mb-3">
                            <label class="small-label" for="email">Email</label>
                            <input type="email" id="email" name="email" class="retro-input <?php if ($submitted) echo empty($errEmail) ? 'is-valid' : 'is-invalid'; ?>" required value="<?= htmlspecialchars($email) ?>">
                            <div class="invalid-feedback"><?= $errEmail ?></div>
                        </div>

                        <div class="col-12 col-lg-4 col-md-6 d-flex flex-column mb-3">
                            <label class="small-label" for="password">Password</label>
                            <input type="password" id="password" name="password" class="retro-input <?php if ($submitted) echo empty($errPassword) ? 'is-valid' : 'is-invalid'; ?>" required>
                        </div>

                        <div class="col-12 col-lg-4 col-md-6 d-flex flex-column mb-3">
                            <label class="small-label" for="password-repeat">Repeat Password</label>
                            <input type="password" id="password-repeat" name="password-repeat" class="retro-input <?php if ($submitted) echo empty($errPassword) ? 'is-valid' : 'is-invalid'; ?>" required>
